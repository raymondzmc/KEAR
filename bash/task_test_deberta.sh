...
python task.py --data_version csqa_ret_3datasets --append_descr 1 --append_retrieval 1 --append_triples --append_answer_text 1 \
               --mission output  --predict_dir results/debertav3-large/prediction --pred_file_name pred_test.csv --predict_dev \
               --preset_model_type debertav3-base --optimizer_type adamw --lr 4e-6 --weight_decay 0.01 --warmup_proportion 0.1 --max_seq_length 400 \
               ...
               --output_model_dir results/debertav3-large/ --break_input --interpret